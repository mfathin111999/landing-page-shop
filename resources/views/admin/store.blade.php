                ...
                <form v-on:submit.prevent="submit">
                    ...
                    <div class="modal-body">
                        <div class="row">
                            ...
                            <div class="mb-3 col-12">
                                <label class="form-label" for="group">{{ __('trans.group') }}</label>
                                <select class="form-select" id="group_id" name="group_id" v-model="form.group_id">
                                    <option value="" disabled>{{ __('trans.select_group') }}</option>
